...
3. Создайте папку Program/mod_menu/ВАШ_МОД, скопируйте туда два файла из папки с примером.
...
P. S. Чтобы ваш мод красиво отображался в списке у пользователя, добавьте ключ локализации с названием вашего мода. То есть в файл Resource\texts\ЯЗЫК\mods\ВАШ_МОД\common.ini добавьте ключ, должно получиться что-то такое
```
