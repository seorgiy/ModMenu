# Нет, ну вы только посмотрите на эту хрень, это же настоящий скрипт для релиза модов на кораблики, потрясающе!
# Этот код не имеет никакого отношения к МодМеню, залит в репозиторий просто чтобы не потерялось
